...
每年计划招收 **3--4 名硕士研究生**。欢迎对机器学习、计算机视觉、三维场景重建和理解等方向感兴趣的同学提前邮件联系（**此外，我要求学生发表的论文必须数据、代码和预训练模型开源**）。
...
- **机器学习与模式识别**：无监督学习、半监督学习、聚类分析与表征学习；
...
- **2025-04-25**：一篇论文被 **ICCV 2025** 接收，恭喜其钰。
