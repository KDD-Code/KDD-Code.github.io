...
近年来，围绕无监督/半监督图像表征学习、视觉基础模型迁移、开放场景识别与多模型协同推理等问题开展研究，在 CVPR、ICCV、AAAI、IEEE TNNLS、IEEE TKDE、IEEE TCSVT、Information Fusion、Neural Networks 等人工智能与计算机视觉领域重要会议和期刊发表论文多篇。

📧 Email: [zhanxuanhu@gmail.com](mailto:zhanxuanhu@gmail.com)

## 🎓 招生信息

每年计划招收 **3--4 名硕士研究生**。欢迎对机器学习、计算机视觉、视觉语言模型、遥感图像理解、医学图像分析、三维场景重建等方向感兴趣的同学提前邮件联系。

我更倾向招收：

- 对科研有持续兴趣，并具有较强自驱力的学生；
- 有读博意向、希望长期从事学术研究的学生；
- 编程基础较好，愿意主动阅读英文论文和复现实验的学生；
- 热爱运动，尤其喜欢跑步的学生。
...
- **机器学习与模式识别**：无监督学习、半监督学习、聚类分析、特征选择与表征学习；
- **视觉基础模型与视觉语言模型**：CLIP 类模型适配、测试时推理、模型选择与多模型集成；
- **开放场景视觉理解**：零样本分类、广义类别发现、开放词汇语义分割；
- **遥感与医学图像智能分析**：遥感场景理解、病理图像分类、多模态医学数据分析；
- **三维场景重建与理解**：前馈式三维/四维重建、场景几何理解与语义增强。
...
- **2025.01 -- 2027.01**，基于视觉基础模型的图像表征学习方法研究，云南省自然科学基金面上项目，主持。
- **2023.01 -- 2025.12**，基于代表性子集标注的大规模图像表征学习方法研究，国家自然科学基金青年项目，主持。
- **2023.01 -- 2025.12**，基于结构化先验的机器人动态光照环境稳定抓取检测方法研究，国家自然科学基金面上项目，参与。
...
- **王怡晨**，2022级硕士，西北工业大学读博。学术成果：KBS 1 篇、Information Sciences 1 篇。
- **徐妍**，2021级本科生，南开大学读研。学术成果：IEEE Signal Processing Letters 1 篇。

<span class='anchor' id='activities'></span>

# 💬 课题组活动

<div class='paper-box'><div class='paper-box-image'><div><img src='/images/group.jpg' alt="group photo" width="100%"></div></div>
...
<div class='paper-box'><div class='paper-box-image'><div><img src='/images/10.jpg' alt="new members" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
